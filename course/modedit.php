...
if ($mform->is_cancelled()) {
    ...
    if ($_POST['checkhomework'] != null) {
        $DB->set_field('assign', 'checkhomework', $_POST['checkhomework'], array('id' => $_POST['instance']));
    } else {
        $DB->set_field('assign', 'checkhomework', 0, array('id' => $_POST['instance']));
    }
